...
```{r}
#' Obtenir les prévisions météo à partir d'une adresse.
#'
#' Cette fonction prend une adresse en tant qu'argument et retourne les prévisions
#' météo associées à cette adresse.
#'
#' @param x Adresse (character) ou coordonnées (numeric).
#'
#' @return Un tibble contenant les données des prévisions météo, tel que :
#'          - L'heure au tz UTC
#'          - Les données de température en °C
#'          - Les données de température ressentie en °C
#'          - La probabilité de pluie en %
...
#'
#' # Pour des coordonnées numériques
#' resultats_finals <- get_forecast(c(37.7749, -122.4194))
#' print(resultats_finals)
#'
#' @export
#'
#' @seealso \code{\link{get_forecast.numeric}}, \code{\link{get_forecast.character}}
#'
#'#' @keywords météo prévisions service-en-ligne
#'
#' @author MOCAËR Rodolphe
#'
